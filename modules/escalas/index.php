                        ...
                        <div class="container mx-auto">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                                    <a href="criar.php" class="block text-center">
                                        <div class="flex flex-col items-center">
                                            <span class="material-symbols-outlined text-6xl text-indigo-600 mb-4">add_circle</span>
                                            <h3 class="text-lg font-semibold text-gray-800">Criar Escala</h3>
                                            <p class="text-gray-600 mt-2">Criar nova escala musical</p>
                                        </div>
                                    </a>
                                </div>
                                ...
                                <div class="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                                    <a href="gerenciar.php" class="block text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <h3 class="text-lg font-semibold text-gray-800">Gerenciar Escalas</h3>
                                            <p class="text-gray-600 mt-2">Visualizar e gerenciar escalas existentes</p>
                                        </div>
                                    </a>
                                </div>
                            </div>
